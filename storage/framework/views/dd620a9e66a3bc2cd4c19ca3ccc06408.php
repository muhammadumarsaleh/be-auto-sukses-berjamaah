                                    ...
                                    <tr data-id="<?php echo e($p->id); ?>">
                                        ...
                                        <td>
                                            <?php if($p->images && count($p->images)): ?>
                                                <img src="<?php echo e(asset('storage/'.$p->images[0]->image_path)); ?>" alt="<?php echo e($p->name); ?>">
                                            <?php else: ?>
                                                <span class="text-muted">No image</span>
                                            <?php endif; ?>
                                        </td>
                                        <td><?php echo e($p->name); ?></td>
                                        <td><?php echo e(Str::limit($p->description, 50)); ?></td>
                                        <td>Rp <?php echo e(number_format($p->price, 0, ',', '.')); ?></td>
                                        <td><?php echo e($p->stock); ?></td>
                                        <td>
                                            <div class="btn-group" role="group">
                                                <button class="btn btn-info btn-sm btnShow" data-id="<?php echo e($p->id); ?>" title="View">
                                                    <i class="ri-eye-line"></i>
                                                </button>
                                                <button class="btn btn-warning btn-sm btnEdit" data-id="<?php echo e($p->id); ?>" title="Edit">
                                                    <i class="ri-pencil-line"></i>
                                                </button>
                                                <button class="btn btn-danger btn-sm btnDelete" data-id="<?php echo e($p->id); ?>" title="Delete">
                                                    <i class="ri-delete-bin-line"></i>
                                                </button>
                                                <button class="btn btn-secondary btn-sm btnAddImage" data-id="<?php echo e($p->id); ?>" title="Add Image">
...
<?php $__env->startSection('script'); ?>
    ...
    $(function () {
        ...
        // helper: reset modal to default state
        ...
        // Edit product (show images + delete button)
        ...
        $(document).on('click', '.btnDelete', function () {
            ...
            $.ajax({
                ...
                error: err => { console.error(err); alert('Failed to delete product.'); }
            });
        });

        // Add Image modal (existing product)
        ...
        // ensure modal inputs are re-enabled when closed (prevent stuck disabled state)
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\corporate\resources\views/pages/product/index.blade.php ENDPATH**/ ?>