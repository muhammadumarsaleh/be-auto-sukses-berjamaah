    ...
    <div class="col-xxl-9">
            ...
            <div class="card-header p-0 border-0 bg-light-subtle">
                <div class="row g-0 text-center">
                    <div class="col-6 col-sm-3">
                        <div class="p-3 border border-dashed bg-light-subtle">
            ...
            <div class="card-body p-0 pb-2">
                <div>
                    <div id="customer_impression_charts"
                        data-colors='["--vz-secondary", "--vz-primary", "--vz-success"]'
        ...
        <div class="row g-4 mb-3">
            <div class="col-sm-auto">
                <div>
                    <a href="apps-ecommerce-add-product" class="btn btn-secondary"><i
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\corporate\resources\views/apps-ecommerce-seller-details.blade.php ENDPATH**/ ?>