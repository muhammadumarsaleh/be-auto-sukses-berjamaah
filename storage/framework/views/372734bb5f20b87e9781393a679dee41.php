                            ...
                            <tbody>
                                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr data-id="<?php echo e($u->id); ?>">
                                        ...
                                        <td>
                                            <?php if($u->avatar): ?>
                                                <img src="<?php echo e(asset('storage/'.$u->avatar)); ?>" alt="<?php echo e($u->name); ?>" class="rounded-circle" width="55" height="55">
                                            <?php else: ?>
                                        ...
                                        <td><?php echo e($u->points); ?></td>
                                        <td>
                                            <div class="btn-group" role="group">
                                                <button class="btn btn-info btn-sm btnShow" data-id="<?php echo e($u->id); ?>" title="View">
                                                    <i class="ri-eye-line"></i>
                                                </button>
                                                <button class="btn btn-warning btn-sm btnEdit" data-id="<?php echo e($u->id); ?>" title="Edit">
                                                    <i class="ri-pencil-line"></i>
                                                </button>
                                                <button class="btn btn-danger btn-sm btnDelete" data-id="<?php echo e($u->id); ?>" title="Delete">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\corporate\resources\views/pages/user/index.blade.php ENDPATH**/ ?>